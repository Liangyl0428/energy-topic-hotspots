...
`v0.2.0` 新增 [500主题新旧算法对照与实测消融报告](docs/V0.2.0_AUDIT.md)：
4500次权重扰动、96个确定性情景、政策组留一；[公开结果与Excel](assets/nmf500/)
可独立复算。核心/新兴沿用评分框架但调整样本门槛；潜在仅作为应用线索。
以下750主题结果作为历史版本保留，不与500主题样本结果混合比较数量。
...
`outputs/nmf500/`。该版覆盖已完成新分类的冻结样本，规模与以下750类全量版不同。
